...
class TransbanksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create transbank" do
    assert_difference('Transbank.count') do
      post transbanks_url, params: { transbank: { category_id: @transbank.category_id, category_type: @transbank.category_type } }
    end
  ...
  test "should update transbank" do
    patch transbank_url(@transbank), params: { transbank: { category_id: @transbank.category_id, category_type: @transbank.category_type } }
